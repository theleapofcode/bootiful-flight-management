...
public class BootifulFlightsSearchApplication implements CommandLineRunner {
	private static final Logger logger = LoggerFactory.getLogger(BootifulFlightsSearchApplication.class);

	@Autowired
	private FlightRepository flightRepository;

	public static void main(String[] args) {
		SpringApplication.run(BootifulFlightsSearchApplication.class, args);
	}
	...
	public void run(String... strings) throws Exception {
		...
		for (Flight flight : flightRepository.findByOriginAndDestinationAndFlightDate("BLR", "CHE", "20-JAN-16")) {
